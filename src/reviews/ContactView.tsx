...
const ContactView = (props:ListProps): ReactElement => {
            ...
            <div>
                {
                    ...
                    >
                    <Avatar alt={data.first_name} src={data.avatar.src} className={classes.avatar} />
                    <ListItemText primary={data.first_name} secondary={data.last_name} />
                    </ListItem>
                    ))
                }
